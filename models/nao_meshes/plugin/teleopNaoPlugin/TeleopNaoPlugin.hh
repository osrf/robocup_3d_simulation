...
#ifndef _GAZEBO_TELEOP_NAO_PLUGIN_HH_
#define _GAZEBO_TELEOP_NAO_PLUGIN_HH_
...
namespace gazebo
{
  class TeleopNaoPlugin : public ModelPlugin
  {
    /// \brief Constructor
    public: TeleopNaoPlugin();

    /// \brief Destructor
    public: virtual ~TeleopNaoPlugin();
