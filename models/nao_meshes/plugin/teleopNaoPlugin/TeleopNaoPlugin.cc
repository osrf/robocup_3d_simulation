...
#include "TeleopNaoPlugin.hh"

using namespace gazebo;

GZ_REGISTER_MODEL_PLUGIN(TeleopNaoPlugin)

/////////////////////////////////////////////////
TeleopNaoPlugin::TeleopNaoPlugin()
{
...
/////////////////////////////////////////////////
void TeleopNaoPlugin::OnHydra(ConstHydraPtr &_msg)
{
...
/////////////////////////////////////////////////
void TeleopNaoPlugin::SetRightFingers(double _angle)
{
...
/////////////////////////////////////////////////
void TeleopNaoPlugin::SetLeftFingers(double _angle)
{
...
/////////////////////////////////////////////////
void TeleopNaoPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  // Get the world name.
  this->model = _parent;
  ...
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
      boost::bind(&TeleopNaoPlugin::Update, this, _1));
}

/////////////////////////////////////////////////
void TeleopNaoPlugin::Update(const common::UpdateInfo & /*_info*/)
{
  boost::mutex::scoped_lock lock(this->msgMutex);
